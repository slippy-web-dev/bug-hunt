...
class BugReports(models.Model):
    ...
    assigned_to_emp_id = models.ForeignKey('Employees', on_delete=models.CASCADE,related_name="assigned_emp")
    comments           = models.CharField(max_length=255)
    status             = models.ForeignKey('Status', on_delete=models.CASCADE)
    priority           = models.ForeignKey('Priorities', on_delete=models.CASCADE)
    resolution         = models.ForeignKey('Resolutions', on_delete=models.CASCADE, related_name="resol")
    resolution_version = models.ForeignKey('Resolutions', on_delete=models.CASCADE, related_name="resol_version")
    resolved_by_emp_id = models.ForeignKey('Employees', on_delete=models.CASCADE, related_name="resolved_emp")
    resolved_on_date   = models.DateField()
    tested_by_emp_id   = models.ForeignKey('Employees', on_delete=models.CASCADE, related_name="tested_emp")
